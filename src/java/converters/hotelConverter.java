...
public class hotelConverter implements Converter {
    ...
    public Object getAsObject(FacesContext fc, UIComponent uic, String value) {
        if(value != null && value.trim().length() > 0) {
            try {
                HotelService service = (HotelService) fc.getExternalContext().getApplicationMap().get("hotelService");
                return service.getHotels().get(Integer.parseInt(value));
    ...
    public String getAsString(FacesContext fc, UIComponent uic, Object object) {
        if(object != null) {
            return String.valueOf(((Hotel) object).getId());
        }
        else {
            return null;
        }
